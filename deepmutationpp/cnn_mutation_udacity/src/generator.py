from deepmutationpp.cnn_mutation_udacity.src.cnn_operator import *
from sklearn.model_selection import train_test_split
from tensorflow.keras.models import load_model
import argparse
from deepmutationpp.cnn_mutation_udacity.src.utils import summary_model, color_preprocessing, model_predict
...
def generator():
    ...
    # load data
    # if data_type == 'lenet':
    #     dataset_folder = "D:\\nargiz\\github\\DeepMutation++\\DeepMutation++\\data\\"
